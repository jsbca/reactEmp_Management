  ...
  return (
    <div className='p-5 bg-[#1c1c1c] mt-5 rounded'>
            ...
            submitHander(e)
                ...
                className='w-full h-44 text-sm py-2 px-4 rounded outline-nome bg-transparent border-[1px] border-gray-400' name="" id="" cols="30" rows="10"></textarea>
                <button className='bg-emerald-500 py-3 hover:bg-emerals-600 px-5 rounded text-sm mt-4 w-full' type="submit">Create Task</button>
                </div>
